 ...
 */
public class TopRatedTVShowsAdapter extends RecyclerView.Adapter<TopRatedTVShowsAdapter.MyViewHolder> {
    private Context mContext;
    private List<TopRatedTVShowsResult> movieList;

    public TopRatedTVShowsAdapter(Context mContext, List<TopRatedTVShowsResult> movieList) {
    ...
    @NonNull
    @Override
    public TopRatedTVShowsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull TopRatedTVShowsAdapter.MyViewHolder viewHolder, int position) {
        TopRatedTVShowsResult movie = movieList.get(position);
