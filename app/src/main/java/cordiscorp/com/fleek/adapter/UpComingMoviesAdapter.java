...
import cordiscorp.com.fleek.model.response.movies_response.UpcomingMovie;
...
public class UpComingMoviesAdapter extends RecyclerView.Adapter<UpComingMoviesAdapter.MyViewHolder> {
    ...
    public UpComingMoviesAdapter(Context mContext, List<UpcomingMovie> movieList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull UpComingMoviesAdapter.MyViewHolder viewHolder, int position) {
        UpcomingMovie movie = movieList.get(position);
