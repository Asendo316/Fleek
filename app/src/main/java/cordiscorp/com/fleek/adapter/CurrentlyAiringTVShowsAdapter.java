 ...
 */
public class CurrentlyAiringTVShowsAdapter extends RecyclerView.Adapter<CurrentlyAiringTVShowsAdapter.MyViewHolder> {
    private Context mContext;
    private List<CurrentlyAiringTVShowsResult> movieList;

    public CurrentlyAiringTVShowsAdapter(Context mContext, List<CurrentlyAiringTVShowsResult> movieList) {
    ...
    @NonNull
    @Override
    public CurrentlyAiringTVShowsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.movie_card_large, viewGroup, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CurrentlyAiringTVShowsAdapter.MyViewHolder viewHolder, int position) {
        CurrentlyAiringTVShowsResult movie = movieList.get(position);
