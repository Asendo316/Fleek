 ...
 */
public class TopRatedMoviesAdapter extends RecyclerView.Adapter<TopRatedMoviesAdapter.MyViewHolder> {
    private Context mContext;
    private List<Movie> movieList;

    public TopRatedMoviesAdapter(Context mContext, List<Movie> movieList) {
    ...
    @NonNull
    @Override
    public TopRatedMoviesAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull TopRatedMoviesAdapter.MyViewHolder viewHolder, int position) {
