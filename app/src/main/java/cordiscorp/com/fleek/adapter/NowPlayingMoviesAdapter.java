 ...
 */
public class NowPlayingMoviesAdapter extends RecyclerView.Adapter<NowPlayingMoviesAdapter.MyViewHolder> {
    private Context mContext;
    private List<NowPlayingMovie> movieList;

    public NowPlayingMoviesAdapter(Context mContext, List<NowPlayingMovie> movieList) {
    ...
    @NonNull
    @Override
    public NowPlayingMoviesAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull NowPlayingMoviesAdapter.MyViewHolder viewHolder, int position) {
